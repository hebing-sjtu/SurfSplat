...
class batchedViewswithdepth(TypedDict, total=False):
    extrinsics: Float[Tensor, "_ 4 4"]
    intrinsics: Float[Tensor, "_ 3 3"]
    image: Float[Tensor, "_ 3 height width"]
    depth: Float[Tensor, "_ height_depth width_depth"]
    near: Float[Tensor, " _"]
    far: Float[Tensor, " _"]
    index: Int64[Tensor, " _"]
...
AnyViews = BatchedViews | UnbatchedViews | batchedViewswithdepth
