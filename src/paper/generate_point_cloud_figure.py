...
with install_import_hook(
    ...
    from src.model.decoder.cuda_splatting import render_cuda_orthographic, cam_info
...
SCENES = (
    ...
    # ("33baf3e18e5d7256", 34, 151, 3.0, [10],[80]),
    # ("46502a6038bd288f", 0, 49, 3.0, [10],[70]),
    # ("12dce44829d88985", 70, 181, 3.0, [10],[60]),
    # ("32294ad73efca3db", 99, 210, 3.0, [10],[80]),
    # ("fc6f664a700121e9", 72, 164, 2.0, [10],[80]),
    
    ("33baf3e18e5d7256", 34, 151, 3.0, [0],[80]),
    ("46502a6038bd288f", 0, 49, 4.0, [0],[70]),
    ("12dce44829d88985", 70, 181, 3.0, [0],[60]),
    ("32294ad73efca3db", 99, 210, 3.3, [0],[80]),
    # ("fc6f664a700121e9", 72, 164, 4.0, [0],[95]),
)
FIGURE_WIDTH = 500
MARGIN = 4
GAUSSIAN_TRIM = 8
...
def generate_point_cloud_figure(cfg_dict):
    ...
    for idx, (scene, *context_indices, far, angles1, angles2) in enumerate(SCENES):
        ...
        for angle1, angle2 in zip(angles1, angles2):
            ...
            rotation = R.from_euler("xyz", [-15 + angle1, angle2 - 90, 0], True).as_matrix()
            ...
            save_image(image, f"{base}_angle_{angle1:0>3}.png")
