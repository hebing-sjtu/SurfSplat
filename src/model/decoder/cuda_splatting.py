...
# ) -> Float[Tensor, "batch 3 height width"]:
    ...
    for i in range(b):
        ...
        # gaussian_opacities = 0.999*torch.ones_like(gaussian_opacities)
    ...
    # return torch.stack(all_images), c_info
    return torch.stack(all_images)


from collections import namedtuple

cam_info = namedtuple("cam_info", ["FoVx", "FoVy", "image_height", "image_width", 
                                   "projection_matrix", "world_view_transform", "full_proj_transform", "camera_center"])
